...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="https://nemolab.id" class="brand-link">
      <img src="{{ asset('template/dist/img/pkl.jpeg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Nemo Lab</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/viewpegawai" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                View Pegawai
              </p>
...
{{--           
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://nemolab.id">NemoLab.id</a>.</strong>
    All rights reserved.
